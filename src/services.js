...
export const PERMISSIONS = {
  ...
  COMMUNICATE_CHURCH_NETWORK: "communicateChurchNetwork",
...
export const PERMISSION_LABELS = {
  ...
  communicateChurchNetwork: ["Church network communication", "Connect and communicate with other congregations on behalf of this church."],
